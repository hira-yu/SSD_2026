...
<section class="staff-hero">
    <div>
        ...
        <p><a class="text-link" href="/staff/product-manager">商品管理トップへ戻る</a></p>
    </div>
    <div class="panel">
        <h3>ログイン情報</h3>
...
<section class="panel">
    <div class="section-heading">
        ...
        <a class="button-link button-submit" href="/staff/product-manager/products/new">商品を新規追加</a>
    </div>
    <form class="search-form receptionist-search-form" method="get" action="/staff/product-manager/products">
        ...
        <div class="search-actions">
            ...
            <a class="button-link button-secondary" href="/staff/product-manager/products">条件クリア</a>
        </div>
    </form>
</section>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if (!empty($product['sale_price'])): ?>
                                ...
                                <small><?= e((string) ($product['sale_starts_at'] ?? '')) ?> - <?= e((string) ($product['sale_ends_at'] ?? '')) ?></small>
                            <?php else: ?>
                                未設定
                            <?php endif; ?>
                        </td>
                        <td>
                            <?php if (!empty($product['available_from']) || !empty($product['available_until'])): ?>
                                <small><?= e((string) ($product['available_from'] ?? '')) ?> - <?= e((string) ($product['available_until'] ?? '')) ?></small>
                            <?php else: ?>
                                常時販売
                            <?php endif; ?>
                        </td>
                        ...
                        <td><a class="button-link button-secondary button-small" href="/staff/product-manager/products/<?= e((string) $product['id']) ?>/edit">編集</a></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
